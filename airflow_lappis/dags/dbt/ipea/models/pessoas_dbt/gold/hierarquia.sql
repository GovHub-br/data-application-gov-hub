with
    ...
    codigos_siorg as (
        select distinct
            ...
            LEAST(eorg.dt_ingest, uo.dt_ingest) as dt_ingest_siorg
    ...
    codigos_siape as (
        select distinct
            ...
            LEAST(df.dt_ingest, dp.dt_ingest, uo.dt_ingest) as dt_ingest_siape
    ...
    tabela_correlacao_cargos as (
        select distinct
            ...
            LEAST(pr.dt_ingest_siorg, pr.dt_ingest_siape, dp.dt_ingest) as dt_ingest
